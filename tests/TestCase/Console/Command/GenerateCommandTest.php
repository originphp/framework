...
class GenerateCommandTest extends OriginTestCase
{
    ...
    public function testGenerateConcernController()
    {
        ...
        $this->assertFileExists($filename);
        $this->assertFileHash('64badea391a85bf286369ec890265819', $filename);
        unlink($filename);
    }
    ...
    public function testGenerateComponent()
    {
        ...
        $this->assertFileExists($filename);
        $this->assertFileHash('27536c07a36f9635beefc98923378847', $filename);
        unlink($filename);
        ...
        $this->assertFileExists($filename);
        $this->assertFileHash('2ad3afcdec72fd2a54c7c6f2269cf94d', $filename);
        unlink($filename);
    }
    ...
    public function testGenerateController()
    {
        ...
        $this->assertFileHash('debb76088baebef8d5697183509db46c', $filename);
        unlink($filename);
    }
    ...
    public function testGenerateControllerWithActions()
    {
        ...
        $this->assertFileHash('b18a8f0b4ea5aac75d5f515a37df4002', $filename);
        unlink($filename);
    }
    ...
    public function testGenerateHelper()
    {
        ...
        $this->assertFileExists($filename);
        $this->assertFileHash('acbee9af57d2c66a2bc437b8a4297654', $filename);
        unlink($filename);
        ...
        $this->assertFileHash('3e61357000b2c5fe48fad5f8ad8fd931', $filename);
        unlink($filename);
    }
    ...
    public function testGenerateMiddleware()
    {
        ...
        $this->assertFileExists($filename);
        $this->assertFileHash('5c25bbcd7ec042791a9a1c22c486f59c', $filename);
        unlink($filename);
    ...
    public function testPlugin()
    {
        ...
        $this->assertFileExists($filename);
        $this->assertFileHash('bc2ad9f52d33a1e21990661cca4454fe', $filename);
